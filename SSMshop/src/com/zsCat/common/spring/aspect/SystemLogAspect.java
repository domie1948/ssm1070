package com.zsCat.common.spring.aspect;
...
import com.zsCat.common.spring.annotation.Log;
import com.zsCat.common.utils.IPUtils;
import com.zsCat.web.sys.model.SysLog;
import com.zsCat.web.sys.service.SysLogService;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.zsCat.common.spring.annotation.Log)")
	public void accessAspect() {
	}
	
	@Pointcut("execution(* com.zsCat.web..*Service.*(..))")
