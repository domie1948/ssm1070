package com.zsCat.common.mybatis.provider;
...
import com.zsCat.common.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            com.zsCat.common.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(com.zsCat.common.mybatis.EntityHelper.getAllColumns(entityClass));
